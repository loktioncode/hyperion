    ...
    <>
      <Nav>
        ...
        <Menu>
            ...
            <li>
                <NavLink activeClassName="active" to="/get-a-quote">Sign Up<FiArrowUpRight /></NavLink>
            </li>
        </Menu>
      ...
      <Overlay open={toggle}>
        <OverlayMenu open={toggle}>
            ...
            <li onClick={() => toggleNav(false)}>
                <NavLink activeClassName="active" to="/get-a-quote">Register <FiArrowUpRight /></NavLink>
            </li>
        </OverlayMenu>
      </Overlay>
    </>
